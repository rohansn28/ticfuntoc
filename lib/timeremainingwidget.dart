...
class TimeRemainingWidget extends StatelessWidget {
  ...
  final String seconds, link, fRoute;
  final Widget nextPage;
  TimeRemainingWidget({
    super.key,
    required this.seconds,
    required this.link, required this.nextPage, required this.fRoute,
  });
  ...
  void handleContinueButton(context) {
    Navigator.pop(context);
    Navigator.pushNamed(context, "/tracking2", arguments: {
      'link': link,
      "seconds": seconds,
      "fRoute": 'playpage',
      "nextPage": nextPage
